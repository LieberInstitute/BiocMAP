#   This script is intended to be run whenever BiocMAP is updated to use newer
#   versions of R or its packages. First, BiocMAP should be tested with the
...
#          BiocMAP uses (instead of manually searching many scripts whenever
...
#          installed by different BiocMAP users
