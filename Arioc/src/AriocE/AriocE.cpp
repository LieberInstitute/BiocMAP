...
/// [public] constructor
AriocE::AriocE( InputFileGroup& ifgRaw, const Nencoding enc,
                ...
                bool emitKmers, UINT32 gpuMask, char* qmdQNAME, INT32 maxJ, AppMain* pam ) :
                            ...
                            m_pam(pam),
                            Params(pam, enc, maxThreads, pam->ConfigFileName, ifgRaw, outDir, samplingRatio, qualityScoreBias, emitKmers, gpuMask, qmdQNAME, pa21sb)
{
