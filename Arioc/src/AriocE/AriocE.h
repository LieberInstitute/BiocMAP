...
class AriocE
{
    ...
    public:
        AriocE( InputFileGroup& ifgRaw, const Nencoding enc, A21SeedBase* pa21sb, char* outDir, const INT32 maxThreads, double samplingRatio, char qualityScoreBias, bool emitKmers, UINT32 gpuMask, char* qmdQNAME, INT32 maxJ, AppMain* pam );
        ~AriocE( void );
