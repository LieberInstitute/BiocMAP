...
struct AriocEncoderParams
{
    ...
    INT16                   maxN;                               // number of symbols in longest encoded read
    ...
    AriocEncoderParams( AppMain* _pam, Nencoding _enc, INT32 _nLPs,
                        ...
                        char _qualityScoreBias, bool _emitKmers, UINT32 _gpuMask, char* _qmdQNAME, A21SeedBase* _pa21sb ) :
                            pam(_pam),
                            Nenc(_enc), nLPs(_nLPs), nSqIn(0), nSqEncoded(0), nSymbolsEncoded(0), nKmersWithN(0), maxN(0),
                            pa21sb(_pa21sb),
                            emitKmers(_emitKmers), gpuMask(_gpuMask),
                            ...
                            ifgRaw(_ifgRaw),
                            OutFilespecStubSq(), OutFilespecStubLUT(), LUTtypeStub(), OutDir(), OutDirLUT(), SymbolEncode(), DnaComplement(),
