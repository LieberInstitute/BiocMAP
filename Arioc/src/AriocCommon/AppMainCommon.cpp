...
AppMainCommon::AppMainCommon() : m_pelRoot(NULL), m_pelX(NULL),
                                 m_maxBatchSize(AriocDS::QID::limitQID),
                                 AppName(), AppVersion(), ConfigFileName(), DataSourceInfo()  // (parentheses cause zero-initialization)
{
}
