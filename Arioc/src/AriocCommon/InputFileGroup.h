...
class InputFileGroup
{
    public:
        ...
        struct FileInfo
        {
            ...
            UINT32                  ofsURI;             // offset of the SAM @SQ URI for the file (in InputFileGroup::UriBuf)
            UINT32                  ofsSN;              // offset of the SAM sequence name (SN) for the file (in InputFileGroup::SnBuf)
            ...
            FileInfo() : Index(-1),
                         ...
                         EstimatedNmax(0), EstimatedSqIdFrom(0), EstimatedSqIdTo(0),
                         IsPaired(false), ofsURI(0), ofsSN(0), RGOrdinal(-1)
            {
            }
        };
...
#pragma pack(pop)
    ...
    public:
        ...
        WinGlobalPtr<char>      SnBuf;          // buffer that contains SN (SAM sequence name) strings
    ...
    public:
        ...
        void Append( const char* fileSpec, INT32 srcId, UINT8 subId, INT64 readIdFrom, INT64 readIdTo, INT32 mateId, const char* uriPathForFile, const char* pSN );
