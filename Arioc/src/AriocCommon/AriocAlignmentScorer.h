...
{
    oftUnknown =    0x0000,
    oftKMH =        0x0001,     // Terabase Search Engine kmer-hashed sequences in Microsoft SQL Server "native" bulk format
    oftTSE =        0x0002,     // Terabase Search Engine fields in Microsoft SQL Server "native" bulk format
    oftSBF =        0x0004,     // SAM fields in Microsoft SQL Server "native" bulk format
    oftSAM =        0x0008,     // SAM

    oftLimit =      oftSAM      // maximum OutputFormatType value
};
