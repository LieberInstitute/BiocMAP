...
/// </summary>
SBFBuilderUnpaired::SBFBuilderUnpaired( QBatch* pqb ) : SBFBuilderBase(pqb), m_invariantFields()
{
...
INT64 SBFBuilderUnpaired::WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
...
INT64 SBFBuilderUnpaired::WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
