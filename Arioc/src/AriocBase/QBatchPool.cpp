...
/// constructor
QBatchPool::QBatchPool( INT32 _maxPool, AriocBase* _pab, GpuInfo* _pgi, INT16 _Nmax ) : m_semPool(0,_maxPool),     // initial count: 0; maximum count: (as specified)
...
/// </summary>
QBatch* QBatchPool::Depool( InputFileGroup::FileInfo* _pfi )
{
#if TODO_CHOP_WHEN_DEBUGGED
