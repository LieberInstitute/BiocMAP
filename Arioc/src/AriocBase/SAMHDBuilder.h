...
class SAMHDBuilder
{
    ...
    static const long           MIN_ENCODER_VERSION_MINOR = 31;
    ...
    public:
        ...
        WinGlobalPtr<char>      SN;             // SN strings for @SQ headers
        WinGlobalPtr<UINT32>    ofsSN;          // per-subId offsets into SN buffer
    ...
    private:
        ...
        void getSN( const char* _pathCfgN, const char* _pathCfgG );
