...
class tuSetupN10 : public tuBaseS, public CudaLaunchCommon
{
    public:
        struct KernelConstants
        {
            ...
            KernelConstants( QBatch* _pqb ) : seedMask(_pqb->pab->a21ss.seedMask),
                                                 hashBitsMask(_pqb->pab->a21ss.hashBitsMask),
                                                 seedWidth(_pqb->pab->a21ss.seedWidth),
                                                 npos(_pqb->pab->a21ss.npos),
                                                 minSeedN(_pqb->pab->a21ss.seedWidth+_pqb->pab->a21ss.npos-1),
                                                 doCTconversion(_pqb->pab->a21ss.baseConvert == A21SpacedSeed::bcCT),
