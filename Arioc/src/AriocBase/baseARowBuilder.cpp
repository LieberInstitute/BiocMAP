...
INT64 baseARowBuilder::WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}

/// [public] method WriteRowUu
INT64 baseARowBuilder::WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}

/// [public] method WriteRowPc
INT64 baseARowBuilder::WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}

/// [public] method WriteRowPd
INT64 baseARowBuilder::WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}

/// [public] method WriteRowPr
INT64 baseARowBuilder::WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}

/// [public] method WriteRowPu
INT64 baseARowBuilder::WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    throw new ApplicationException( __FILE__, __LINE__, "not implemented" );
}
#pragma endregion
