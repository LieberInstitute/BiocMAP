...
#pragma endregion
    ...
    protected:
        QBatch*                 m_pqb;
        AriocBase*              m_pab;
        INT32                   m_cbRow;                    // maximum number of bytes in one output row
    ...
    public:
        ...
        virtual INT64 WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI );   // unpaired: unmapped read
        virtual INT64 WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI );   // unpaired: mapped read
        virtual INT64 WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );   // paired: concordant pair
        virtual INT64 WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );   // paired: discordant pair
        virtual INT64 WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );   // paired: rejected pair
        virtual INT64 WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );   // paired: unmapped pair
};
