...
class SAMBuilderPaired : public SAMBuilderBase
{
    ...
    private:
        ...
        INT64 writeMatesUnpaired( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI, const char* pYT );
    ...
    protected:
        ...
        // optional fields
        virtual UINT32 emitc3( char* pbuf, INT64 sqId, QAI* pQAI );
    ...
    public:
        ...
        virtual INT64 WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );
        virtual INT64 WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );
        virtual INT64 WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );
        virtual INT64 WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI );
 };
