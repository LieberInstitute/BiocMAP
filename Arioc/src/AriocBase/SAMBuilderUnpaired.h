...
class SAMBuilderUnpaired : public SAMBuilderBase
{
    ...
    public:
        ...
        virtual INT64 WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI );
        virtual INT64 WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI );
};
