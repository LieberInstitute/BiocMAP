...
/// </summary>
SBFBuilderPaired::SBFBuilderPaired( QBatch* pqb ) : SBFBuilderBase(pqb), m_pQAIx(NULL), m_fragmentLength(0),
                                                    m_invariantFields()     // (parentheses cause zero-initialization)
{
...
INT64 SBFBuilderPaired::WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    m_arf = pPAI->arf;
...
INT64 SBFBuilderPaired::WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    m_arf = pPAI->arf;
...
INT64 SBFBuilderPaired::writeMatesUnpaired( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    m_arf = pPAI->arf;
    m_fragmentLength = 0;
...
INT64 SBFBuilderPaired::WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    return writeMatesUnpaired( pofb, iBuf, sqId, pPAI );
}

/// [public] method WriteRowPu
INT64 SBFBuilderPaired::WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    return writeMatesUnpaired( pofb, iBuf, sqId, pPAI );
}
#pragma endregion
