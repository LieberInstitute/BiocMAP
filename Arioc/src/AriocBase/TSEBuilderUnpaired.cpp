...
INT64 TSEBuilderUnpaired::WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
...
INT64 TSEBuilderUnpaired::WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
    char* p0 = pofb->ReserveOutputBuffer( iBuf, m_cbRow );
    if( p0 )
    {
