...
UINT32 SAMBuilderUnpaired::emitc3( char* pbuf, INT64 sqId, QAI* pQAI )
{
    ...
    const UINT32 iMate = 0;
    const UINT32 iMetadata = pQAI->qid;
...
INT64 SAMBuilderUnpaired::WriteRowUm( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
...
INT64 SAMBuilderUnpaired::WriteRowUu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, QAI* pQAI )
{
