...
INT64 TSEBuilderPaired::writeMatesUnpaired( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    m_fragmentLength = 0;
...
INT64 TSEBuilderPaired::WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    char* p0 = pofb->ReserveOutputBuffer( iBuf, m_cbRow );
    if( p0 )
    {
...
INT64 TSEBuilderPaired::WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    char* p0 = pofb->ReserveOutputBuffer( iBuf, m_cbRow );
    if( p0 )
    {
...
INT64 TSEBuilderPaired::WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    // set up the mapping category bits
    m_mapCat = mcRejected;
...
INT64 TSEBuilderPaired::WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
