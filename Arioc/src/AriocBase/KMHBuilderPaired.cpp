...
INT64 KMHBuilderPaired::WriteRowPc( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    ...
    // return the number of concordant mappings
    return 0;
}

/// [public] method WriteRowPd
INT64 KMHBuilderPaired::WriteRowPd( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    char* p0 = pofb->ReserveOutputBuffer( iBuf, m_cbRow );
    if( p0 )
    {
    ...
    // return the number of discordant mappings
    return 2;
}
...
INT64 KMHBuilderPaired::writeMatesUnpaired( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
...
INT64 KMHBuilderPaired::WriteRowPr( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
    // set up the mapping category bits
    m_mapCat = mcRejected;
...
INT64 KMHBuilderPaired::WriteRowPu( OutputFileBinding* pofb, INT32 iBuf, INT64 sqId, PAI* pPAI )
{
