...
#define VER_FILEVERSION             1,40,$WCREV$,$WCDATE=%y%j$
#define VER_FILEVERSION_STR         "1.40.$WCREV$.$WCDATE=%y%j$\0"

#define VER_PRODUCTVERSION          1,40,0,0
#define VER_PRODUCTVERSION_STR      "1.40\0"

#define VER_LEGALCOPYRIGHT_STR      "Copyright (c) 2015-$WCNOW=%Y$ Johns Hopkins University.  All rights reserved."

#define VER_REVISIONDATETIME_STR    "$WCDATE=%Y-%m-%dT%H:%M:%S$\0"
#endif
