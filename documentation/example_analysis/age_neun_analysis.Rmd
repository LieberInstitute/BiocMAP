...
dmr_gr_wide = resize(
    dmr_gr, width = width(dmr_gr) + 2 * exploration_radius, fix = "center"
)
...
```{r Figure4, out.width="100%", fig.align="center", fig.cap = "Genomic region containing differential methylation between neurons and glia. Red methylation curves represent neuronal samples, whereas blue curves represent glial samples. Windows highlighted in light red show DMRs determined in the manuscript between groups."}
plotRegion(
