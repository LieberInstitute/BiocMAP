...
#  methylation
meta_df$high_meth_cpg <- DelayedArray::colMeans(assays(bs_cpg)$M[1:100000,] > 0.1)
meta_df$high_meth_cph <- DelayedArray::colMeans(assays(bs_cph)$M[1:100000,] > 0.1)
...
```{r Figure3, out.width="100%", fig.align="center", fig.cap = ""}
ggplot(
    meta_df_long, 
