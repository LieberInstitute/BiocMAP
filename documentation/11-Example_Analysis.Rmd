...
```{r, eval=FALSE}
ggplot(data.frame(colData(bs_cpg)), aes(x = Cell.Population, y = lambda_bs_conv_eff)) +
...
ggplot(data.frame(colData(bs_cpg)), aes(x = perc_M_CpG, y = perc_M_CHG)) +
    geom_point(color = Cell.Population)

ggplot(data.frame(colData(bs_cpg)), aes(x = perc_M_CpG, y = perc_M_CHH)) +
    geom_point(color = Cell.Population)

ggplot(data.frame(colData(bs_cpg)), aes(x = perc_M_CHG, y = perc_M_CHH)) +
    geom_point(color = Cell.Population)
```
